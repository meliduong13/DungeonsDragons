//! @file 
//! @brief Nimble implementation class  
//!
#pragma once
#include "Nimble.h"
#include <iostream>
...
//! Implementation create a character according of specified type (Nimble)
//! @param chType: 
//! @return void: this function creates a character from a given character type (Nimble) 
void Nimble::buildCharacter() {

	const int abilitySize = 6;//_ch->getAbilities.size();
	...
	// Order of prefrences for Nimble from biggest to smallest score: Dexterity, Constitution, Strength, Intelligence, Charisma, Wisdom
	...
	_ch->getAbility("Dexterity")->setScore(abilityScore[5]);
}